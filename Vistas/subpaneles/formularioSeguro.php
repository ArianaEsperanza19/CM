...
if(isset($_SESSION['seguro']) == 1){
    ...
    $redirect = "?controller=Cliente&action=registrar_info_seguro&cliente=$id_titular";
    ...
    <input value='$group_number' type='text' id='group_number' name='group_number'><br><br>
    ...
    <label for='group_number'>Número de grupo:</label><br>
    <input type='text' id='group_number' name='group_number'><br><br>
    
    <label for='plan_seguro'>Plan de seguro:</label><br>
    <input type='text' id='plan_seguro' name='plan_seguro'><br><br>
