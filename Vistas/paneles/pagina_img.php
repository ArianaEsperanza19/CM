...
if (isset($_GET['add']) && isset($_GET['cliente']) && $_GET['add'] == 0) {
    ...
    if (isset($_GET['add']) && isset($_GET['cliente']) && $_GET['add'] == 1) {
        echo "
    <div id='datos' class='formularioCaja'>
    ...
    <input id='imgField' type='file' name='imagen' required><br>
    ...
    <label for='imagen'>Imagen:</label><br>
    <input id='imgField' type='file' name='imagen'><br>
    <img class='miniatura' src='Vistas/img/$Img' alt='Imagen'><br>
    <input id='enviar' style='margin-left: 0px' type='submit' value='Enviar'>
    </form>
    </div></div></div>";
    }
}
